...
(function () {
  const traducciones = {
    es: {
      ...
      pagBtnEfectivo: "💵 Efectivo",
      efTitulo: "💵 Pago en efectivo",
      efIniciando: "Conectando con la máquina de efectivo...",
      efInserta: "Inserta los billetes en la máquina",
      efRecibido: "Recibido",
      efPagado: "✅ ¡Pago completado!",
      efCambio: "Cambio entregado",
      efFaltante: "Cambio pendiente (no entregado)",
      efCancelado: "Pago cancelado.",
      efCancelar: "Cancelar",
      efError:
        "No se pudo conectar con la máquina de efectivo. Pide ayuda en recepción.",
      efOcupado:
        "La máquina está ocupada con otro pago. Intenta en un momento.",
      efCambioNota: "El cambio se entrega solo en billetes de $5.000.",
      efTexto:
        "Acércate a la recepción para completar tu pago en efectivo. No tiene ningún recargo.",
    ...
    en: {
      ...
      pagBtnEfectivo: "💵 Cash",
      efTitulo: "💵 Cash payment",
      efIniciando: "Connecting to the cash machine...",
      efInserta: "Insert the bills into the machine",
      efRecibido: "Received",
      efPagado: "✅ Payment completed!",
      efCambio: "Change dispensed",
      efFaltante: "Change pending (not dispensed)",
      efCancelado: "Payment cancelled.",
      efCancelar: "Cancel",
      efError:
        "Could not connect to the cash machine. Please ask at reception.",
      efOcupado:
        "The machine is busy with another payment. Please try again shortly.",
      efCambioNota: "Change is given only in $5,000 COP bills.",
      efTexto:
        "Please go to the reception desk to complete your cash payment. There is no surcharge.",
    ...
    de: {
      ...
      pagBtnEfectivo: "💵 Bargeld",
      efTitulo: "💵 Barzahlung",
      efIniciando: "Verbindung zum Bargeldautomaten wird hergestellt...",
      efInserta: "Bitte die Scheine in den Automaten einlegen",
      efRecibido: "Erhalten",
      efPagado: "✅ Zahlung abgeschlossen!",
      efCambio: "Ausgegebenes Wechselgeld",
      efFaltante: "Ausstehendes Wechselgeld (nicht ausgegeben)",
      efCancelado: "Zahlung abgebrochen.",
      efCancelar: "Abbrechen",
      efError:
        "Verbindung zum Bargeldautomaten fehlgeschlagen. Bitte an der Rezeption nachfragen.",
      efOcupado:
        "Der Automat ist mit einer anderen Zahlung beschäftigt. Bitte gleich erneut versuchen.",
      efCambioNota: "Wechselgeld wird nur in 5.000-COP-Scheinen ausgegeben.",
      efTexto:
        "Bitte gehen Sie zur Rezeption, um Ihre Barzahlung abzuschließen. Es fällt kein Aufschlag an.",
    ...
    fr: {
      ...
      pagBtnEfectivo: "💵 Espèces",
      efTitulo: "💵 Paiement en espèces",
      efIniciando: "Connexion à la machine à espèces...",
      efInserta: "Insérez les billets dans la machine",
      efRecibido: "Reçu",
      efPagado: "✅ Paiement terminé !",
      efCambio: "Monnaie rendue",
      efFaltante: "Monnaie en attente (non rendue)",
      efCancelado: "Paiement annulé.",
      efCancelar: "Annuler",
      efError:
        "Impossible de se connecter à la machine à espèces. Demandez de l'aide à la réception.",
      efOcupado:
        "La machine traite un autre paiement. Réessayez dans un instant.",
      efCambioNota: "La monnaie est rendue uniquement en billets de 5 000 COP.",
      efTexto:
        "Veuillez vous rendre à la réception pour effectuer votre paiement en espèces. Aucun supplément.",
    ...
    zh: {
      ...
      efCancelado: "付款已取消。",
      efCancelar: "取消",
      efError: "无法连接现金机。请到前台寻求帮助。",
      efOcupado: "机器正在处理另一笔付款。请稍后再试。",
      efCambioNota: "找零仅以 5,000 COP 纸币发放。",
      efTexto: "请前往前台完成现金付款。无额外费用。",
      trTitulo: "🏦 银行转账付款",
      trLlave: "Bre-B 密钥：",
      trNequi: "Nequi：",
      trDaviplata: "Daviplata：",
    ...
    ja: {
      ...
      pagBtnEfectivo: "💵 現金",
      efTitulo: "💵 現金でのお支払い",
      efIniciando: "現金機に接続しています…",
      efInserta: "紙幣を機械に投入してください",
      efRecibido: "受領",
      efPagado: "✅ お支払いが完了しました！",
      efCambio: "返却されたお釣り",
      efFaltante: "未返却のお釣り",
      efCancelado: "お支払いがキャンセルされました。",
      efCancelar: "キャンセル",
      efError: "現金機に接続できませんでした。フロントにお問い合わせください。",
      efOcupado: "機械は別の支払いを処理中です。しばらくしてからお試しください。",
      efCambioNota: "お釣りは5,000 COP紙幣のみで返却されます。",
      efTexto: "現金でのお支払いはフロントで完了してください。手数料はかかりません。",
      trTitulo: "🏦 銀行振込でのお支払い",
      trLlave: "Bre-B キー：",
      trNequi: "Nequi：",
      trDaviplata: "Daviplata：",
