...
(function () {
  const traducciones = {
    es: {
      ...
      estadoSi: "Sí",
      estadoNo: "No",
      btnCheckin: "✅ Realizar mi check-in en línea",
      checkinListo: "✔️ Tu check-in ya está realizado.",
      qrCheckin: "📱 Escanea con tu celular para hacer el check-in",
    ...
    en: {
      ...
      estadoSi: "Yes",
      estadoNo: "No",
      btnCheckin: "✅ Complete my online check-in",
      checkinListo: "✔️ Your check-in is already done.",
      qrCheckin: "📱 Scan with your phone to check in",
    ...
    de: {
      ...
      estadoSi: "Ja",
      estadoNo: "Nein",
      btnCheckin: "✅ Meinen Online-Check-in durchführen",
      checkinListo: "✔️ Ihr Check-in ist bereits erfolgt.",
      qrCheckin: "📱 Mit dem Handy scannen, um einzuchecken",
    ...
    fr: {
      ...
      estadoSi: "Oui",
      estadoNo: "Non",
      btnCheckin: "✅ Effectuer mon check-in en ligne",
      checkinListo: "✔️ Votre check-in est déjà effectué.",
      qrCheckin: "📱 Scannez avec votre téléphone pour faire le check-in",
    ...
    ja: {
      ...
      estadoSi: "はい",
      estadoNo: "いいえ",
      btnCheckin: "✅ オンラインチェックインを行う",
      checkinListo: "✔️ チェックインは完了しています。",
      qrCheckin: "📱 スマートフォンでスキャンしてチェックイン",
